...
function FlipCard({
    ...
    return (
        ...
        >
            ...
            >
                {/* Front Face */}
                <a href="http://controlsacademy.net/" target="_blank" rel="noopener noreferrer"
                    className="absolute inset-0 h-full w-full overflow-hidden rounded-xl shadow-lg bg-white flex items-center justify-center p-1"
                ...
                >
                    <div className="text-center">
                        <p className="text-[8px] font-bold text-blue-400 uppercase tracking-widest mb-1">Visit</p>
...
const MAX_SCROLL = 1000; // Virtual scroll range

// Unsplash Images + Controls Academy Logo
const IMAGES = [
    "https://controlsacademy.net/logo.png",
];
...
export default function IntroAnimation() {
    ...
    useEffect(() => {
        ...
        const handleWheel = (e: WheelEvent) => {
            ...
            if ((isScrollingDown && scrollRef.current >= MAX_SCROLL) || 
                (isScrollingUp && scrollRef.current <= 0)) {
    ...
    const scatterPositions = useMemo(() => {
        return IMAGES.map((_, i) => ({
            x: (Math.sin(i * 12.9898) - 0.5) * 1500,
            y: (Math.cos(i * 78.233) - 0.5) * 1000,
            rotation: (Math.sin(i * 43.123) - 0.5) * 180,
            scale: 0.6,
            opacity: 0,
        }));
    }, []);
    ...
    return (
        <div ref={containerRef} className="relative w-full h-screen min-h-[600px] bg-background overflow-hidden">
            {/* Container */}
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
                    ...
                    <motion.p
                        ...
                        className="mt-4 text-lg font-medium tracking-wide text-muted-foreground"
                    >
                        Used by the leaders.
                    </motion.p>
                </div>
                ...
                <div className="relative flex items-center justify-center w-full h-full">
                    {IMAGES.slice(0, TOTAL_IMAGES).map((src, i) => {
                        ...
                        if (introPhase === "scatter") {
                            ...
                            const step = TOTAL_IMAGES > 1 ? spreadAngle / (TOTAL_IMAGES - 1) : 0;
                            ...
                            const currentArcAngle = TOTAL_IMAGES > 1 ? startAngle + (i * step) + boundedRotation : -90;

...
const SERVICES = [
  {
    ...
    description:
      "Leading the preparation and issuance of tender packages, analyzing requirements, and managing supplier relationships for quality compliance and cost savings.",
    image:
      "https://picsum.photos/seed/tendering/1200/800",
  },
  {
    id: "02",
    title: "Cost Estimation & Control",
    description: "Developing accurate cost estimation models, monitoring project costs, tracking changes, and managing valuations and payments.",
    image:
      "https://picsum.photos/seed/cost/1200/800",
  },
  {
    id: "03",
    title: "Contract Administration",
    description:
      "Administering construction contracts, tracking milestones, payments, and claims, ensuring projects are delivered on budget.",
    image:
      "https://picsum.photos/seed/contract/1200/800",
  },
];
      ...
      <div className="w-full px-4 md:px-8 lg:px-12 xl:px-20 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-end h-full order-1 lg:order-2">
            ...
            >
              <div className="relative aspect-4/5 md:aspect-4/3 lg:aspect-16/11 rounded-3xl md:rounded-[2.5rem] overflow-hidden bg-muted/30 shadow-lg">
                <AnimatePresence
                  initial={false}
                  custom={direction}
                  mode="popLayout"

...
const defaultMarkers: PulseMarker[] = [
  { id: "cairo", location: [30.0444, 31.2357], delay: 0 },
  { id: "riyadh", location: [24.7136, 46.6753], delay: 0.5 },
  { id: "dubai", location: [25.2048, 55.2708], delay: 1 },
]
...
export function GlobePulse({
  ...
  return (
    <div className={`relative aspect-square select-none ${className}`}>
      <style>{`@keyframes pulse-expand { 0% { transform: scaleX(0.3) scaleY(0.3); opacity: 0.8; } 100% { transform: scaleX(1.5) scaleY(1.5); opacity: 0; } }`}</style>
      <canvas
        ref={canvasRef}

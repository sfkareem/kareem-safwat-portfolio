    ...
    <>
        ...
        {active && (
          ...
          >
            <motion.div
              ...
              {...props}
            >
              <motion.div layoutId={`image-${title}-${id}`} className="relative h-80">
                <div className="relative h-full before:absolute before:inset-x-0 before:bottom-[-1px] before:h-[70px] before:z-50 before:bg-gradient-to-t dark:before:from-zinc-950 before:from-zinc-50">
                  <Image
                    src={src}
                    alt={title}
                    fill
      ...
      >
        <div className="flex gap-4 flex-col">
          <motion.div layoutId={`image-${title}-${id}`} className="relative w-64 h-56">
            <Image
              src={src}
              alt={title}
              fill
